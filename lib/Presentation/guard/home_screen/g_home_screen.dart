                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  ((visitorProv.idCard != null &&
                                      ...
                                      visitorProv.memberShipModel != null
                                  ...
                                  RoundedButton(
                                    ...
                                    ontap: () async {
                                      ...
                                      if(visitorProv.memberShipModel != null){
                                        print('bb');
                                        if(visitorProv.memberShipModel.identityImagePath == null && visitorProv.memberShipModel.carImagePath == null){
                                          print('cc');
                                          Fluttertoast.showToast(
                                              msg: 'برجاء إلتقاط الصور أولاً',
                                        ...
                                        showLoaderDialog(
                                            context, 'Loading...');
                                       // log('type id   ${widget.memberShipModel.ownerTypeId.toString()}');
                                        ...
                                        widget.screen == 'invitation'
                                          ...
                                          if (value ==
                                            ...
                                            context, listen: false)
                                            .getBill(
                                            widget.memberShipModel.ownerTypeId
                                                .toString(), '0', '0')
                                            .then((value) {
                                          print(
                                              'value is $value');
