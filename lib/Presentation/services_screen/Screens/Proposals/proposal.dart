...
class _ProposalScreenState extends State<ProposalScreen> {
  ...
  Future<void> selectImages() async {
    ...
    switch (_listImagePaths.length) {
      case 1:
        {
          imgFile1 = File(_listImagePaths[0].path.toString());
          //images.add(imgFile1);
      ...
      case 2:
        {
          imgFile1 = File(_listImagePaths[0].path.toString());
          imgFile2 = File(_listImagePaths[1].path.toString());
        }
        break;
      case 3:
        {
          imgFile1 = File(_listImagePaths[0].path.toString());
          imgFile2 = File(_listImagePaths[1].path.toString());
          imgFile3 = File(_listImagePaths[2].path.toString());
        }
        break;
    }
