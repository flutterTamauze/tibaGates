...
/*      appBar: AppBar(
     ...
     /*       Flexible(
        ...
        ):isConnecting?const Center(child: CircularProgressIndicator()):Column(children:  [
          const Text('حدث خطأ فالإتصال برجاء المحاولة لاحقاً'),
          RoundedButton(
            ontap: () {
